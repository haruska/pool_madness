class SchemaReset < ActiveRecord::Migration
  def up
    create_table 'brackets', force: true do |t|
      ...
      t.integer 'best_possible',        default: 20_000
    end
    ...
    add_index 'picks', %w(bracket_id game_id), name: 'index_picks_on_bracket_id_and_game_id', unique: true
    ...
    add_index 'teams', %w(region seed), name: 'index_teams_on_region_and_seed', unique: true
